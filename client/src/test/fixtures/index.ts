...
export const mockCompactRounds: CompactRound[] = [
  { round: 1, matches: [], byeTeams: [], hasTeamLists: false },
  { round: 2, matches: [], byeTeams: [], hasTeamLists: false },
  { round: 3, matches: [], byeTeams: [], hasTeamLists: false },
  { round: 4, matches: [], byeTeams: [], hasTeamLists: false },
  { round: 5, matches: [], byeTeams: ['BRI', 'CAN'], hasTeamLists: false },
  { round: 6, matches: [], byeTeams: ['CBY', 'CRO'], hasTeamLists: false },
  { round: 7, matches: [], byeTeams: ['DOL', 'GLD'], hasTeamLists: false },
  { round: 8, matches: [], byeTeams: ['MAN', 'MEL'], hasTeamLists: false },
  { round: 9, matches: [], byeTeams: ['NEW', 'NZL'], hasTeamLists: false },
  { round: 10, matches: [], byeTeams: ['NTH', 'PAR'], hasTeamLists: false },
  { round: 11, matches: [], byeTeams: ['PEN', 'SGI'], hasTeamLists: false },
  { round: 12, matches: [], byeTeams: ['SOU', 'SYD', 'WST'], hasTeamLists: false },
  { round: 13, matches: [], byeTeams: [], hasTeamLists: false },
  { round: 14, matches: [], byeTeams: [], hasTeamLists: false },
  { round: 15, matches: [], byeTeams: [], hasTeamLists: false },
  { round: 16, matches: [], byeTeams: [], hasTeamLists: false },
  { round: 17, matches: [], byeTeams: [], hasTeamLists: false },
  { round: 18, matches: [], byeTeams: [], hasTeamLists: false },
  { round: 19, matches: [], byeTeams: [], hasTeamLists: false },
  { round: 20, matches: [], byeTeams: [], hasTeamLists: false },
  { round: 21, matches: [], byeTeams: [], hasTeamLists: false },
  { round: 22, matches: [], byeTeams: [], hasTeamLists: false },
  { round: 23, matches: [], byeTeams: [], hasTeamLists: false },
  { round: 24, matches: [], byeTeams: [], hasTeamLists: false },
  { round: 25, matches: [], byeTeams: [], hasTeamLists: false },
  { round: 26, matches: [], byeTeams: [], hasTeamLists: false },
  { round: 27, matches: [], byeTeams: [], hasTeamLists: false },
];
